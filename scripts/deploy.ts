...
async function main() {
  ...
  console.log(`${colors.bright}LINGUADAO DEPLOYMENT TO ${networkName.toUpperCase()}${colors.reset}`);
  ...
  log(`Account balance: ${ethers.formatEther(balance)} ETH`, "info");
  ...
  try {
    ...
    const LinguaToken = await ethers.getContractFactory("LinguaToken");
    ...
    const VoiceSharesNFT = await ethers.getContractFactory("VoiceSharesNFT");
    ...
    const LinguaDAO = await ethers.getContractFactory("LinguaDAO");
    ...
    const LanguagePoolsAMM = await ethers.getContractFactory("LanguagePoolsAMM");
    ...
    const ExtinctionInsurance = await ethers.getContractFactory("ExtinctionInsurance");
