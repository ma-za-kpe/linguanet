...
async function main() {
  ...
  console.log(`${colors.bright}LINGUADAO DEPLOYMENT TO BASE SEPOLIA TESTNET${colors.reset}`);
  ...
  try {
    ...
    log(`Transaction hash: ${linguaToken.deploymentTransaction().hash}`, "info");

    // Wait for confirmations
    log("Waiting for confirmations...", "info");
    await linguaToken.deploymentTransaction().wait(2);
    ...
    await voiceSharesNFT.deploymentTransaction().wait(2);
    ...
    await linguaDAO.deploymentTransaction().wait(2);
    ...
    await languagePoolsAMM.deploymentTransaction().wait(2);
    ...
    await extinctionInsurance.deploymentTransaction().wait(2);
    ...
    console.log(`\n${colors.green}✅ All contracts deployed successfully to Base Sepolia!${colors.reset}`);
    console.log(`\n${colors.cyan}View on BaseScan:${colors.reset}`);
    console.log(`LinguaToken: https://sepolia.basescan.org/address/${contracts.linguaToken}`);
    console.log(`VoiceSharesNFT: https://sepolia.basescan.org/address/${contracts.voiceSharesNFT}`);
    console.log(`LinguaDAO: https://sepolia.basescan.org/address/${contracts.linguaDAO}`);
    console.log(`LanguagePoolsAMM: https://sepolia.basescan.org/address/${contracts.languagePoolsAMM}`);
    console.log(`ExtinctionInsurance: https://sepolia.basescan.org/address/${contracts.extinctionInsurance}`);
    
    console.log(`\n${colors.cyan}Next Steps:${colors.reset}`);
    console.log("1. Verify contracts on BaseScan using: npm run verify");
